...
from literary_companion.tools.gcs_tool import gcs_reader_tool, gcs_writer_tool
from literary_companion.tools.translation_tool import translation_tool
from literary_companion.tools.gcs_tool import book_processor_tool

# The detailed instruction prompt that guides the LLM's behavior.
...
book_preparation_coordinator = Agent(
    ...
    description="Orchestrates the one-time processing of a novel for the Literary Companion.",
    instruction=PREPARATION_AGENT_INSTRUCTION,
